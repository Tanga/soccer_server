...
class SeedsController < ApplicationController
  ...
  def initialize_apps
    @fixtures_app  = SoccerHexagon::Fixtures::App.new #repository: SoccerHexagon::Fixtures::SQLRepository
    @pitches_app   = SoccerHexagon::Pitches::App.new  #repository: SoccerHexagon::Pitches::SQLRepository
    @teams_app     = SoccerHexagon::Teams::App.new    #repository: SoccerHexagon::Teams::SQLRepository
    @players_app   = SoccerHexagon::Players::App.new  #repository: SoccerHexagon::Players::SQLRepository
    @matches_app   = SoccerHexagon::Matches::App.new  #repository: SoccerHexagon::Matches::SQLRepository
  end
end
